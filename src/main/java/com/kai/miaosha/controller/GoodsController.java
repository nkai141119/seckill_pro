...
import com.kai.miaosha.vo.GoodsDetailVo;
...
public class GoodsController {
	 ...
	 */
	//现版本用的是这个
	//produces指定返回的类型，这里是文本型html。有ResponseBody的情况下默认为json。相对的属性为consumes，指定输入的类型
	...
	public String toListCache(Model model,MiaoshaUser user,HttpServletRequest request,
		...
		//realkey = GoodsKey:gl+key,但是这里key是空
		//注意getGoodsList中设置了默认过期时间为60秒
